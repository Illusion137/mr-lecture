// Baked-in k2-fsa sherpa-onnx Swift API wrapper (v1.13.2), compiled inside the
// MrLecture module so PiperEngine can use it. Gated on the SherpaOnnx C module
// (the local ios/SherpaOnnx pod); absent it, this file is empty and PiperEngine
// falls back to its #else stub. Source: swift-api-examples/SherpaOnnx.swift.
